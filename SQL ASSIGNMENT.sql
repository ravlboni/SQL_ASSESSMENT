...
select concat(first_name," ",last_name) as employee,job_id as title from employees;

-- 4. Display the hire date, name and department number for all clerks.
select hire_date,concat(first_name, " " , last_name) as name ,department_id from employees where job_id = 'clerks';
...
select concat(first_name," ",last_name) as Ename, department_id as deptno,salary from employees order by salary desc;

-- 11. Display the last name and job title of all employees who do not have a manager
select concat(first_name," ",last_name) as Name,job_title from employees,jobs where job_title like "manager";
...
select last_name,job_title,salary from employees,jobs where job_title="Sales Representative" or job_title="Stock Clerk" and salary!=2500 and salary!=3500 and salary!=5000;
...
-- 9) Select the employee name, department id, and the salary. Group the result with the manager name and the employee last name should have second letter 'a!
select concat(first_name,' ',last_name) as employees_name,department_id,salary,job_title from employees join jobs on employees.job_id=jobs.job_id where job_title like'%Manager%' and substr(last_name,2,1)='a' and substr(first_name,2,1)='a' order by department_id;
select * from jobs;

-- 10) Display the average of sum of the salaries and group the result with the department id. Order the result with the department id.
